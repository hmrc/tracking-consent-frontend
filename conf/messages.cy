cookieSettings.title = Lorem ipsum
...
cookieSettings.intro.paragraph1 = Lorem ipsum
cookieSettings.intro.paragraph2 = We use cookies to store information about how you use HMRC services, such as the pages you visit.
cookieSettings.intro.paragraph3 = We use 4 types of cookie. You can choose which cookies you’re happy for us to use.

cookieSettings.unsupported.paragraph1 = Lorem ipsum
...
cookieSettings.measurement.title = Lorem ipsum
cookieSettings.measurement.paragraph1 = We use Google Analytics to measure how you use the website so we can improve it based on user needs. We do not allow Google to use or share the data about how you use this site.
...
cookieSettings.measurement.settingid = usage

cookieSettings.marketing.title = Lorem ipsum
cookieSettings.marketing.paragraph1 = These cookies may be set by third party websites and do things like measure how you view YouTube videos that are on HMRC services.
...
cookieSettings.marketing.settingid = campaigns

cookieSettings.settings.title = Lorem ipsum
cookieSettings.settings.paragraph1 = These cookies do things like remember your preferences and the choices you make, to personalise your experience of using the site.
cookieSettings.settings.settinglabel.on = Use cookies that remember my settings on the site
cookieSettings.settings.settinglabel.off = Do not use cookies that remember my settings on the site
cookieSettings.settings.settingid = settings

cookieSettings.necessary.title = Lorem ipsum
cookieSettings.necessary.paragraph1 = These essential cookies do things like remember your progress through a form (for example a licence application)
...
cookieSettings.saveConfirmation.title = Lorem ipsum
